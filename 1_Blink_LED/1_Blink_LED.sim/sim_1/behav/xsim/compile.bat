...
REM
REM Generated by Vivado on Thu May 28 15:17:56 -0400 2026
...
echo "xvhdl --incr --relax -prj TB_Blink_LED_vhdl.prj"
call xvhdl  --incr --relax -prj TB_Blink_LED_vhdl.prj -log xvhdl.log
