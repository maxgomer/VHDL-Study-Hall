...
#--------------------------------------------------------------------------------------------------
# 3_SPI_LED_Screen - Project Notes
#
#   For this project, we need a clock object that is driven by the board's CLK100MHZ system clock
#   which is wired to an IO pin on the FPGA. We also need to define mappings to the PMOD connector
#   pins that will be used to drive the PMOD LED screen
#--------------------------------------------------------------------------------------------------
