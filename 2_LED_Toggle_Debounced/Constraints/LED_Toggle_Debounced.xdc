...
#--------------------------------------------------------------------------------------------------
# 2_LED_Toggle_Debounced - Project Notes
#
#   For this project, we need a clock object that is driven by the board's CLK100MHZ system clock
#   which is wired to an IO pin on the FPGA, a definition for the LED[0] IO port, and a definition
#   for the center button (BTNC - N17) IO Port.
#--------------------------------------------------------------------------------------------------
